...
//	
	...
	public String getClaimVefDetailsClaimStatus(int rowIndex)
	{
		By claimStatus=By.xpath("//*[@id='getClaimVerifyDetails']/div/div/div/div[2]/div/table/tbody/tr["+rowIndex+"]/td[5]/label");
