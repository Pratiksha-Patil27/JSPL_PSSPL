...
//			}
	...
	public void verifyCallsAvailability() throws InterruptedException 
	{
		try {
			...
			By nextDialTextLocator=By.xpath("//h4[@class=\"text-info fw-bold\"]");
			Thread.sleep(2000);
			WebElement nextDialTextElement = driver.findElement(nextDialTextLocator);			
			...
			String customerContact, String customerAddress, String filePath) throws InterruptedException
	{
		      ...
		      By dealerDroDownLocators=By.xpath("//div[@class= \"css-1nmdiq5-menu\"]/div/div");
				WaitVisibliltyOfLocated(dealerDroDownLocators);
				List<WebElement> dealerElements = driver.findElements(dealerDroDownLocators);
				...
				// Select Invoice Date
				Thread.sleep(3000);
				By dateInputLocator=By.xpath("//*[@class= \"input-group\"]/input[2]");
				WaitVisibliltyOfLocated(dateInputLocator);
				...
				// Enter Customer Name
				By customerNameLocator=By.id("CUSTOMERNAME");
				sendkeys(customerNameLocator,customerName);
				
				// Enter Customer Mobile No.
				By customerMoLocator=By.id("CUSTOMERMOBILENO");
				sendkeys(customerMoLocator,customerContact);
				
				// Enter Address
				By addressLocator=By.id("CUSTOMERADDRESS");
				sendkeys(addressLocator,customerAddress);
				

				// Upload File
				By uploadElement=By.id("fileUploadInput");
				sendkeys(uploadElement,filePath);
	...
	public void callActionButton(String actionButtonValue) {
		...
		By callLocators=By.xpath("//div[@class=\"page-content\"]/div/header/div/div[2]/div/button");
		WaitVisibliltyOfLocated(callLocators);
	...
	public void selectRescheduleStatus(String statusValue) throws InterruptedException  {
		...
		Thread.sleep(2000);
		By statusDropdownLocator= By.xpath("//div[@class=\"css-5736gi-menu\"]/div/div");
		WaitVisibliltyOfLocated(statusDropdownLocator);
		//List<WebElement> statusDropdownElements = driver.findElements(By.xpath("//div[@id=\"react-select-2-listbox\"]/div/div"));
		 List<WebElement> statusDropdownElements = driver.findElements(By.xpath("//div[@class=\"css-5736gi-menu\"]/div/div"));
